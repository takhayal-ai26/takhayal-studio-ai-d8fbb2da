            ...
            {(form as any).preview_image_url ? (
              ...
              <button
                ...
                onDrop={e => {
                  ...
                  if (file?.type.startsWith('image/')) handlePreviewUpload(file);
                }}
                className={`w-full aspect-video rounded-2xl border-2 border-dashed flex flex-col items-center justify-center gap-2 transition-all cursor-pointer ${
                  isDraggingPreview
