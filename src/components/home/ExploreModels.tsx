        ...
        <div className="flex gap-4 min-w-max pb-2">
          {featuredGuides.map(guide => (
            <button
              ...
              className="group relative flex-shrink-0 w-[240px] md:w-[280px] aspect-[3/4] rounded-2xl overflow-hidden hover:shadow-xl hover:shadow-primary/10 transition-all duration-400 hover:scale-[1.02]"
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5">
                ...
                <ArrowRight
                  size={14}
                  className={`text-primary mt-3 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-300 ${isRTL ? 'rotate-180' : ''}`}
                />
              </div>
            </button>
          ))}
