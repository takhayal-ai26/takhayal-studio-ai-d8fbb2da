...
export const HOME_SEO_CONTENT = {
  ...
  ar: {
    answerTitle: 'ما هو تخيّل؟',
    answer:
      'تخيّل هو استوديو ذكاء اصطناعي عربي أولاً مخصص للكويت والخليج. يساعد العلامات التجارية والمبدعين على توليد الصور، وتعديل صور المنتجات، واستكشاف القوالب، ومقارنة النماذج الإبداعية ضمن منصة واحدة.',
    sections: [
      {
        title: 'لماذا يستخدم مبدعو الخليج تخيّل',
        items: [
          'أوامر وسير عمل عربي أولاً',
...
export const PRICING_SEO_CONTENT = {
  ...
  ar: {
    ...
    answer:
      'يعمل تخيّل بنظام أرصدة واضح لاستخدام أدوات الصور والمهام الإبداعية بالذكاء الاصطناعي. يمكنك البدء مجاناً ثم الترقية إلى خطط شهرية أو سنوية مع معرفة تكلفة التوليد قبل التنفيذ.',
    comparison: {
      ...
      rows: [
        ...
        ['مرونة شحن الأرصدة', 'لزيادة السعة عند الحاجة بدون تغيير كامل للخطة'],
      ],
    },
    faqs: [
      {
        ...
        answer:
          'الرصيد هو وحدة الاستخدام التي تُخصم عند تشغيل أدوات الصور أو تنفيذ المهام الإبداعية. ويختلف الاستهلاك حسب الأداة أو النموذج.',
      },
      {
        question: 'هل يمكن البدء بدون بطاقة؟',
        answer:
          'نعم. تم تصميم البداية المجانية لتجربة المنصة قبل الانتقال إلى باقة مدفوعة.',
      },
      {
        question: 'هل يمكنني الترقية لاحقاً؟',
        answer:
          'نعم. يمكنك البدء بخطة صغيرة ثم الانتقال إلى خطة أعلى عندما تحتاج إلى حجم استخدام أكبر.',
      },
    ],
  },
};
...
export const TOOLS_DIRECTORY_SEO_CONTENT = {
  ...
  ar: {
    answerTitle: 'ما الأدوات التي يقدمها تخيّل؟',
    answer:
      'يوفر تخيّل أدوات صور بالذكاء الاصطناعي عربية أولاً لتوليد الصور، وتحسين الدقة، وإنشاء الشعارات، وإزالة الخلفية، وتعديل الصور، وترميم الصور القديمة. كل أداة مصممة لحل مهمة إنتاجية محددة.',
    comparison: {
      columns: ['نوع الأداة', 'أفضل استخدام لها'],
      rows: [
        ['توليد الصور', 'تحويل الأوامر إلى صور جاهزة للحملات'],
...
export const MODELS_DIRECTORY_SEO_CONTENT = {
  ...
  ar: {
    ...
    answer:
      'يساعد دليل النماذج في تخيّل المستخدمين على مقارنة محركات الصور والفيديو حسب السرعة والجودة وأفضل استخدام والأسلوب الإبداعي. الهدف هو اختيار النموذج الأنسب قبل بدء التوليد.',
    comparison: {
...
export const TEMPLATES_SEO_CONTENT = {
  ...
  ar: {
    ...
    answer:
      'قوالب تخيّل هي نقاط انطلاق جاهزة للإعلانات، وحملات الجمال، ومحتوى الطعام، والمواد الاجتماعية للعلامات التجارية. تساعد الفرق على الانتقال من الصورة المرجعية إلى نتيجة قوية بشكل أسرع.',
  },
};
...
export const CREATE_SEO_CONTENT = {
  ...
  ar: {
    ...
    answer:
      'مركز الإنشاء هو أسرع طريقة لبدء إنتاج الصور أو الفيديو بالذكاء الاصطناعي داخل تخيّل. يوجّه المستخدم إلى المسار المناسب سواء كان يحتاج إلى توليد صورة جديدة أو استخدام أداة معينة أو إنشاء فيديو.',
  },
};
...
export function buildToolSeoContent(tool: {
  ...
  if (isAr) {
    return {
      ...
      answer: `${tool.name} هي أداة داخل تخيّل تساعدك على ${tool.shortDesc || tool.description}. تم تصميمها للمبدعين والعلامات التجارية التي تحتاج نتائج أسرع وأكثر وضوحاً في سير العمل الإبداعي.`,
      useCasesTitle: 'أفضل استخدامات هذه الأداة',
      useCases: [
        `إنجاز مهام ${tool.name} بسرعة داخل نفس المنصة`,
...
export function buildModelSeoContent(guide: {
  ...
  if (isAr) {
    return {
      answerTitle: `ما هو نموذج ${name}؟`,
      answer: `${name} هو نموذج داخل تخيّل يركز على ${bestFor}. ${description}`,
      comparison: {
...
export function buildTemplateSeoContent(template: {
  ...
  if (isAr) {
    return {
      ...
      answer: `${title} هو قالب جاهز داخل تخيّل لمساعدتك على إنتاج محتوى بصري أسرع ضمن فئة ${template.category} وبنسبة ${template.ratio}.`,
      checklistTitle: 'لماذا يفيدك هذا القالب',
      checklist: [
        'يقلل وقت البدء من الصفر',
        'يعطيك اتجاه بصري واضح للحملة أو المنتج',
        `يحافظ على تناسب مناسب مثل ${template.ratio}`,
      ],
    };
  }
