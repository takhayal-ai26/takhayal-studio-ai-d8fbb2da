...
export const seoLandingPages: Record<SeoLandingPageKey, SeoLandingPageConfig> = {
    ...
    faqs: [
      {
        ...
        answer: {
          ar: 'نعم. تخيّل تجربة عربية أولاً، مصمَّمة للفرق والمبدعين الذين يعملون على الحملات والصور والمحتوى الاجتماعي في الكويت والخليج.',
      ...
      },
      {
        ...
        answer: {
          ar: 'يدعم تخيّل تجربتين، عربية وإنجليزية، عبر صفحات وأدوات موجَّهة للمستخدمين في المنطقة.',
  ...
  'ai-image-tools-kuwait': {
    ...
    tableRows: [
      {
        ar: ['متجر أو مطعم', 'صور منتجات ومحتوى عروض', 'القوالب وأدوات الإنشاء'],
    ...
    limitations: {
      ar: ['قد تحتاج الصور التجارية لمراجعة قانونية أو حقوقية قبل النشر', 'الصور الناتجة تحتاج تدقيقاً عند استخدام شعارات أو منتجات حساسة', 'المنصة لا تستبدل التصوير الاحترافي في كل الحالات'],
    ...
    faqs: [
      {
        ...
        answer: {
          ar: 'أفضل استخدام: إنتاج صور الحملات والمنتجات والمحتوى الاجتماعي بسرعة، بسياق عربي وخليجي واضح.',
      ...
      },
      {
        ...
        answer: {
          ar: 'نعم. نظام الأرصدة والقوالب والأدوات المنفصلة يجعل تخيّل مناسباً للتجربة التدريجية وللفرق الصغيرة.',
  ...
  'arabic-ai-design-tool': {
    ...
    tableRows: [
      ...
      {
        ar: ['المهام', 'إنشاء، تعديل، قوالب، نماذج', 'اختيار مسار واضح بدلاً من أداة واحدة عامة'],
    ...
    limitations: {
      ar: ['لا يستبدل مدير الهوية أو المصمم في القرارات النهائية', 'النتائج تختلف حسب جودة البرومبت والصورة المرجعية', 'تحتاج المشاريع الكبيرة إلى مراجعة داخلية قبل الإطلاق'],
    ...
    faqs: [
      {
        ...
        answer: {
          ar: 'يعني أن تجربة المنتج وتموضعه ومحتواه موجَّهة منذ البداية للمستخدم العربي والخليجي، لا ترجمة لاحقة لتجربة أجنبية.',
      ...
      },
      {
        ...
        answer: {
          ar: 'يركّز تخيّل على إنتاج الصور والأصول الإبداعية بالذكاء الاصطناعي، لا على استبدال كل أدوات التصميم التقليدية.',
  ...
  'canva-ai-alternative-gcc': {
    ...
    directAnswer: {
      ar: 'Canva منصة تصميم واسعة، بينما يركّز تخيّل على إنتاج الصور والأصول بالذكاء الاصطناعي لتجارب عربية وخليجية. يعتمد الاختيار على حاجتك: محرّر تصميم شامل، أم مسارات ذكاء اصطناعي مركَّزة للصور والقوالب والنماذج.',
    ...
    tableRows: [
      {
        ar: ['الاستخدام الرئيسي', 'تصميم شامل وقوالب عالمية', 'إنتاج صور وأصول بالذكاء الاصطناعي، عربية أولاً'],
        en: ['Primary use', 'Broad design and global templates', 'Arabic-first AI image and asset production'],
      },
      {
        ar: ['السياق الإقليمي', 'عام وعالمي', 'موجَّه للكويت والخليج'],
        en: ['Regional context', 'General and global', 'Focused on Kuwait and the GCC'],
      },
      {
        ar: ['أفضل للفرق التي تريد', 'تحرير تصاميم كثيرة في مساحة واحدة', 'تجربة صور ونماذج وقوالب بالذكاء الاصطناعي، بسرعة'],
        en: ['Best for teams that need', 'Editing many design types in one workspace', 'Fast AI image, model, and template workflows'],
      },
    ],
    useCases: {
      ar: ['فرق خليجية تحتاج صور حملات بسرعة', 'علامات تريد تجربة أفكار عربية قبل التصميم النهائي', 'فرق تستخدم Canva للتصميم وتحتاج مساراً متخصصاً لصور الذكاء الاصطناعي'],
    ...
    faqs: [
      {
        ...
        answer: {
          ar: 'ليس دائماً. تخيّل بديل أو مكمِّل حين تكون الأولوية لإنتاج صور وأصول بالذكاء الاصطناعي عربية وخليجية، بينما Canva أوسع كمنصة تصميم عامة.',
      ...
      },
      {
        ...
        answer: {
          ar: 'اختر تخيّل حين تحتاج أدوات صور ونماذج وقوالب موجَّهة للفرق العربية في الكويت والخليج.',
  ...
  'canva-ai-alternative': {
    ...
    directAnswer: {
      ar: 'إن كان هدفك تحرير تصميمات كثيرة، فقد يناسبك Canva. وإن كان هدفك إنتاج صور وأصول بالذكاء الاصطناعي عربية أولاً، مع أدوات ونماذج وقوالب مركَّزة — فتخيّل مسار أكثر تخصصاً لهذا النوع من العمل.',
    ...
    tableRows: [
      ...
      {
        ar: ['هل أحتاج صوراً بالذكاء الاصطناعي عربيةً أولاً؟', 'قد يعمل حسب الاستخدام', 'هذا مجال التركيز'],
    ...
    useCases: {
      ar: ['فرق تستخدم Canva وتريد مسار صور بالذكاء الاصطناعي متخصصاً', 'علامات عربية تحتاج قوالب وصور لحملات سريعة', 'مسوقون يريدون مقارنة الأدوات قبل الاشتراك'],
    ...
    limitations: {
      ar: ['لا يقدم تخيّل نفس نطاق أدوات التصميم العامة في Canva', 'ليست كل مهام التصميم مناسبة لأداة ذكاء اصطناعي واحدة', 'يجب مراجعة النتائج قبل استخدامها تجارياً'],
    ...
    faqs: [
      {
        ...
        answer: {
          ar: 'نعم. أنتج الصور والأصول في تخيّل، ثم استخدمها داخل Canva أو أي أداة تصميم أخرى.',
      ...
      },
      {
        ...
        answer: {
          ar: 'الفرق الرئيسي: Canva منصة تصميم عامة، بينما يركّز تخيّل على مسارات صور وقوالب ونماذج بالذكاء الاصطناعي، عربية أولاً.',
  ...
  'midjourney-alternative-arabic-brands': {
    ...
    eyebrow: { ar: 'مقارنة منشئي الصور', en: 'Image generator comparison' },
    h1: { ar: 'بديل Midjourney للعلامات العربية', en: 'Midjourney alternative for Arabic brands' },
    directAnswer: {
      ar: 'Midjourney منشئ صور قوي للاستكشاف البصري. أما تخيّل فيركّز على تسهيل إنتاج الصور للعلامات العربية، عبر أدوات موجَّهة، قوالب، دليل نماذج، وتسعير بالأرصدة — داخل تجربة عربية وإنجليزية.',
    ...
    tableRows: [
      {
        ar: ['نمط الاستخدام', 'استكشاف وإنشاء بالبرومبتات', 'أدوات وقوالب ونماذج ضمن واجهة واحدة'],
    ...
    useCases: {
      ar: ['فرق تبحث عن بديل أكثر توجيهاً من البرومبت الحر', 'علامات تحتاج قوالب وأدوات إلى جانب الإنشاء', 'مقارنة نماذج قبل اختيار مسار الإنتاج'],
    ...
    limitations: {
      ar: ['Midjourney قد يكون أفضل لبعض التجارب الفنية الحرة', 'يركّز تخيّل أكثر على سير العمل والإنتاج العملي', 'لا توجد أداة واحدة مثالية لكل أنواع الصور'],
    ...
    faqs: [
      {
        ...
        answer: {
          ar: 'تعتمد الأفضلية على الاستخدام. Midjourney قوي للاستكشاف الفني، أما تخيّل فمناسب حين تحتاج علامة عربية إلى أدوات وقوالب وسير عمل واضح.',
      ...
      },
      {
        ...
        answer: {
          ar: 'نعم. استخدم Midjourney للاستكشاف، وتخيّل لمسارات إنتاج أكثر تنظيماً، داخل تجربة عربية أولاً.',
