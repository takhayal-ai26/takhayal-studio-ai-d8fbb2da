          ...
          <div className="relative max-w-4xl mx-auto text-center py-20 md:py-24">
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-center">
                <button
                  onClick={handleStartCreating}
                  className="group w-full max-w-md h-14 rounded-full bg-primary text-primary-foreground text-base md:text-lg font-medium hover:brightness-110 transition-all duration-300 hover:shadow-[0_0_40px_rgba(245,81,48,0.35)] hover:scale-[1.02]"
                >
                  Start Creating
